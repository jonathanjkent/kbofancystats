...
tenteam <- tenteam %>% subset(str_sub(Date, 1, 4) == 2021)
...
plot <- ggplot(tenteam, aes(Date, Elo, color = Team)) + geom_line() + theme_minimal() + scale_color_brewer(palette="Paired")
