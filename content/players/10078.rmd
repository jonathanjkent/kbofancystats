...
d <- subset(d, Code == "10078", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1439-An-Juhyeong-Samsung-Lions)
