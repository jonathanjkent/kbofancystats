...
d <- subset(d, Code == "10477", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1496-Jo-Byung-wook-KT-Wiz)
