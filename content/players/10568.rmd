...
d <- subset(d, Code == "10568", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1509-Yoon-Seongpin-Lotte-Giants)
