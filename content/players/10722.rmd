...
d <- subset(d, Code == "10722", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1531-Choi-Jiguang-Samsung-Lions)
