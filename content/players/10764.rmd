...
subtitle: SSG Landers | SS
summary: "Career Stats"
---
```{r , echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(kableExtra))
d <- readRDS("~/Google Drive/KBO/batters_simple.rds")
d <- subset(d, Code == "10764", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1537-Park-Seonghan-SSG-Landers)
