...
d <- subset(d, Code == "11772", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1681-An-Woojin-Kiwoom-Heroes)
