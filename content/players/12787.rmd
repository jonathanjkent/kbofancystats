...
d <- subset(d, Code == "12787", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1826-Lee-Sangyung-LG-Twins)
