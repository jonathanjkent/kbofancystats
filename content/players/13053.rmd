...
d <- subset(d, Code == "13053", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1864-Yoon-Sanheum-Hanwha-Eagles)
