...
d <- subset(d, Code == "13214", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1887-Oh-Donguk-Hanwha-Eagles)
