...
d <- subset(d, Code == "13228", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1889-Jo-Hanmin-Hanwha-Eagles)
