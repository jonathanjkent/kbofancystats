...
d <- subset(d, Code == "13424", select = c(-Name, -KName, -Position, -Code, -Url))
d <- d[order(-d$Year),]
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1917-Seo-Ho-cheol-NC-Dinos)
