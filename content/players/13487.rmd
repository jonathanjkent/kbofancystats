...
d <- subset(d, Code == "13487", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1926-Kim-Juhyung-Kiwoom-Heroes)
