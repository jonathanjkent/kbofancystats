...
d <- subset(d, Code == "13508", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1929-Lee-Myuongki-Kiwoom-Heroes)
