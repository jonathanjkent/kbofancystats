...
d <- subset(d, Code == "13627", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1946-Park-Myeonghyeon-Lotte-Giants)
