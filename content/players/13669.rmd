...
d <- subset(d, Code == "13669", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1952-Hong-Minki-Lotte-Giants)
