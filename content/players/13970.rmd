...
d <- subset(d, Code == "13970", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1995-Kim-Byeonghwi-Kiwoom-Heroes)
