...
d <- subset(d, Code == "14040", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2005-Yang-Chan-yeol-Doosan-Bears)
