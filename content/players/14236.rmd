...
d <- subset(d, Code == "14236", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2033-Jang-Woongjeong-Hanwha-Eagles)
