...
d <- subset(d, Code == "14418", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2059-Yang-Seonryul-SK-Wyverns)
