...
d <- subset(d, Code == "14719", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2102-Addison-Russell-Kiwoom-Heroes)
