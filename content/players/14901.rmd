...
d <- subset(d, Code == "14901", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2128-Bae-Donghyun-Hanwha-Eagles)
