...
d <- subset(d, Code == "15048", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2149-Artie-Lewicki-SSG-Landers)
