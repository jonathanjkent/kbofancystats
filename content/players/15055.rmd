...
d <- subset(d, Code == "15055", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2150-Jang-Jihun-SSG-Landers)
