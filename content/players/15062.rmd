...
subtitle: SSG Landers | RHP
summary: "Career Stats"
---
```{r , echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(kableExtra))
d <- readRDS("~/Google Drive/KBO/pitchers_simple.rds")
d <- subset(d, Code == "15062", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2151-Jo-Byeonghyeon-SSG-Landers)
