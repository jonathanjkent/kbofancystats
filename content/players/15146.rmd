...
d <- subset(d, Code == "15146", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2163-Zoilo-Almonte-KT-Wiz)
