...
d <- subset(d, Code == "15181", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2168-Josh-Smith-Kiwoom-Heroes)
