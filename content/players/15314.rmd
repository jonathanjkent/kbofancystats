...
d <- subset(d, Code == "15314", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2187-Lee-Juchan-Lotte-Giants)
