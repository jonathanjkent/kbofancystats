...
d <- subset(d, Code == "15657", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2236-Lee-Juhyeong-Kiwoom-Heroes)
