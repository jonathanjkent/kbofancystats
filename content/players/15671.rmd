...
d <- subset(d, Code == "15671", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2238-David-Freitas-Kiwoom-Heroes)
