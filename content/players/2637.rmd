...
d <- subset(d, Code == "2637", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/376-Jung-Euiyoon-SSG-Landers)
