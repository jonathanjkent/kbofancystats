...
d <- subset(d, Code == "264", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/37-Oh-Hyountaek-Lotte-Giants)
