...
d <- subset(d, Code == "4058", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/579-Choi-Keumkang-NC-Dinos)
