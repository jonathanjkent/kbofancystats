...
d <- subset(d, Code == "4527", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/646-An-Youngmyung-KT-Wiz)
