...
d <- subset(d, Code == "6018", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/859-Park-Juntae-Kiwoom-Heroes)
