...
d <- subset(d, Code == "7418", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1059-Park-Sewong-Samsung-Lions)
