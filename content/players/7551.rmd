...
subtitle: SSG Landers | LHP
summary: "Career Stats"
---
```{r , echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(kableExtra))
d <- readRDS("~/Google Drive/KBO/pitchers_simple.rds")
d <- subset(d, Code == "7551", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1078-Kim-Taekhyeong-SSG-Landers)
