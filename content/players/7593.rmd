...
d <- subset(d, Code == "7593", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1084-Song-Sungmun-Kiwoom-Heroes)
