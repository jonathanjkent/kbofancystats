...
d <- subset(d, Code == "7978", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1139-Huh-Jungheop-Kiwoom-Heroes)
