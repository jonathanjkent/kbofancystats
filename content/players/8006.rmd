...
d <- subset(d, Code == "8006", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1143-Kim-Keonkuk-Lotte-Giants)
