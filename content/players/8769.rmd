...
d <- subset(d, Code == "8769", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1252-Lee-Geunwook-SSG-Landers)
