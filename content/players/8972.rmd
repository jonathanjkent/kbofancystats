...
d <- subset(d, Code == "8972", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1281-Kim-Hyunjun-Kia-Tigers)
