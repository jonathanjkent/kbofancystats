...
d <- subset(d, Code == "9021", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1288-Choi-Wonjun-Kia-Tigers)
