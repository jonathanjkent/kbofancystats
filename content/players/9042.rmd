...
subtitle: SSG Landers | 1B
summary: "Career Stats"
---
```{r , echo=F,warning=FALSE,message=FALSE}
suppressMessages(library(kableExtra))
d <- readRDS("~/Google Drive/KBO/batters_simple.rds")
d <- subset(d, Code == "9042", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1291-Nam-Taehyeok-SSG-Landers)
