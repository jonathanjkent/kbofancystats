---
date: "2021-03-31"
summary: 'WAR Leader | Ryan Carpenter, LHP: 2.54'
title: 'Hanwha Eagles'
subtitle: 'Daejeon | Current Elo: 1431 (10)'
image:
  preview_only: true
---
**2021** | [Batting](#batting) | [Pitching](#pitching) | 
**2020** | [Batting](https://www.kbofancystats.com/teams-2020/HanwhaEagles/#batting) | [Pitching](https://www.kbofancystats.com/teams-2020/HanwhaEagles/#pitching) | 
...
d <- batters %>% filter(Team == "Hanwha Eagles") %>% filter(Year == "2021") %>% select(-Team, -Year, -KName, -Url)
d <- d[order(-d$WAR),]
...
d <- pitchers %>% filter(Team == "Hanwha Eagles") %>% filter(Year == "2021") %>% select(-Team, -Year, -KName, -Position, -Url)
d <- d[order(-d$WAR),]
d$Name <- paste0("[", d$Name, "](/players/", d$Code, ")")
d <- d %>% select(-Code)
