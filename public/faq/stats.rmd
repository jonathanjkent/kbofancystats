...
batters <- batters %>% subset(Year == "2019") %>% subset(PA > 446) %>% select(BABIP, BBpct, SOpct, ISO, OPS, WAR)
pitchers <- pitchers %>% subset(Year == "2019") %>% subset(IP2 > 144) %>% select(BABIP, BB9, SO9, HR9, FIP, WAR)
