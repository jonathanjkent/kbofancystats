...
d <- subset(d, Code == "11436", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1633-Bae-Changhyeon-Doosan-Bears)
