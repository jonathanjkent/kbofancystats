...
d <- subset(d, Code == "13641", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1948-Adrian-Sampson-Lotte-Giants)
