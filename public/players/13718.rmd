...
d <- subset(d, Code == "13718", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1959-Hwang-Dong-jae-Samsung-Lions)
