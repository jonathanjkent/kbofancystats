...
d <- subset(d, Code == "13739", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1962-Han-Seungju-Hanwha-Eagles)
