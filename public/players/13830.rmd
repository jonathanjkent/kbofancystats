...
d <- subset(d, Code == "13830", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1975-Ryu-Hyoseung-SK-Wyverns)
