...
d <- subset(d, Code == "13907", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1986-Im-Hyeongwon-NC-Dinos)
