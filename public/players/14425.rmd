...
d <- subset(d, Code == "14425", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2060-Lee-Geoyeon-SK-Wyverns)
