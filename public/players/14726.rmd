...
d <- subset(d, Code == "14726", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/2103-Daniel-Palka-Samsung-Lions)
