...
d <- subset(d, Code == "5689", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/812-Jeong-Gihun-Hanwha-Eagles)
