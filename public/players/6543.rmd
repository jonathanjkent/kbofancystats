...
d <- subset(d, Code == "6543", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/934-Kang-Dongkwan-Lotte-Giants)
