...
d <- subset(d, Code == "7600", select = c(-Name, -KName, -Position, -Code, -Url))
...
```
<br>
**More** | [myKBO Page](https://mykbostats.com/players/1085-Song-Woohyun-Kiwoom-Heroes)
